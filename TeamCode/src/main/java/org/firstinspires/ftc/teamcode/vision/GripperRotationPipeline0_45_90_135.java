...
public class GripperRotationPipeline0_45_90_135 extends OpenCvPipeline {
    ...
    GripperAngle gripperAngle = GripperAngle.ANGLE_0;
    ...
    public Mat processFrame(Mat input) {
        ...
        try {
            ...
            l_contourf = new MatOfPoint2f(new Point(0,0));
        }
    ...
    public GripperAngle getAngle(){
        if(angle<67.5 && angle>22.5) return GripperAngle.ANGLE_45;
        else if(angle>67.5 && angle<112.5) return GripperAngle.ANGLE_90;
        else if(angle>112.5 && angle<157.5) return GripperAngle.ANGLE_135;
        else return GripperAngle.ANGLE_0;
    }
