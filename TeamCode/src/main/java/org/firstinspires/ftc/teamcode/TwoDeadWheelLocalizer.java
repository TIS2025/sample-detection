...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = -284.96159330750305; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -3047.070508286701; // x position of the perpendicular encoder (in tick units)
    }
