...
public class SampleDetectionPipelinePNP extends OpenCvPipeline
{
    ...
    public SampleDetectionPipelinePNP()
    {
        ...
        double fx = 462.24; // Replace with your camera's focal length in pixels
        double fy = 462.24;
        double cx = 0; // Replace with your camera's principal point x-coordinate (usually image width / 2)
        double cy = 0; // Replace with your camera's principal point y-coordinate (usually image height / 2)
